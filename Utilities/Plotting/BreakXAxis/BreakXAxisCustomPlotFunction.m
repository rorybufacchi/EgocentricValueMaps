function h=BreakXAxis(x,y,start,stop,width,PlotFun,varargin);

% Julie Haas, after Michael Robbins
% - assumes dx is same for all data
% - 'width' must be a whole number
% - PlotFun defines which function should be used to plot the data
%       (e.g. 'plot', 'scatter' etc)
%       It should take as inputs x, and y, then varargin
