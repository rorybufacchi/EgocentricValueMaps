function plotRowAveragesWithSpread(data, spreadWidth, plotTitle, xLabel, yLabel)
...
%     bar(rowAverages);
    ...
    for i = 1:nRows
        ...
        uniqueVals = uniqueVals(~isnan(uniqueVals));
        counts = counts(~isnan(uniqueVals));
