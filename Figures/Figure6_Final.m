...
for iF = 1:length(allFields)
    ...
    saveas(f.(cF).f,['Results\Outputs\Figure6_ModelEmpirical_' cF '.png'] , 'png')
    saveas(f.(cF).f,['Results\Outputs\Figure6_ModelEmpirical_' cF '.eps'] , 'epsc')
    saveas(f.(cF).f,['Results\Outputs\Figure6_ModelEmpirical_' cF '.pdf'] , 'pdf')
