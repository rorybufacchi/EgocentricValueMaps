...
% !HOWEVER! a pre-computed version of most of the data can also be 
% loaded (much faster) from:
...
warning(sprintf([' \n --------------------------------------------- \n ' ...
    'To plot the figures from here on out, you need to first run the ' ...
    'following section of "CreateDataForPlots_Final.m": \n' ...
    '"ANN Model 6, PART 2/3: precomputing more variables (Fig 5, ExtDat Fig3)" \n ' ...
    ' YOu should set "netSize" to "BigNets" (option A) for the figure in the main text, and to "SmallNets" (option B) for the supplementary figures \n \n ' ...
    'Running this section will store the outputs on your computer, so you will only need to ' ...
    'do it once, but it will take quite long \n' ...
    '---------------------------------------------']));
...
if ~exist('netSize', 'var') || strcmp(netSize,'BigNets')
    ...
    try
        ...
        error(sprintf(['No Precomputed data found for the small networks. ' ...
            'Please Compute results using CreateDataForPlots.m, section \n' ...
            '"ANN Model 6, PART 2/3: precomputing more variables (Fig 5, ExtDat Fig3)" \n, ' ...
            'setting "netSize" to "SmallNets" (option B) ']));
    end
end
