...
% USE:
% 
% - Run this script to re-create the elements used for making figure 2 of the
% main paper
%
% - The data
% -----
...
% % % tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\HeadTemplate.jpg');
...
tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\MonkeyTopDown2Poses_V2_Narrow.jpg');
alphaChan = ~all(tmpFig > 250, 3);
image(tmpFig,'AlphaData',alphaChan); axis off
...
tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\MonkeyTopDown2Poses_NoBubbles_Narrow.jpg');
alphaChan = ~all(tmpFig > 250, 3);
image(tmpFig,'AlphaData',alphaChan); axis off
...
tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\BrainAreas.jpg');
alphaChan = ~all(tmpFig > 250, 3);
image(tmpFig,'AlphaData',alphaChan); axis off
...
tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\NeurNET.jpg');
alphaChan = ~all(tmpFig > 250, 3);
image(tmpFig,'AlphaData',alphaChan); axis off
...
tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\MonkeyTopDown1Pose.jpg');
alphaChan = ~all(tmpFig > 250, 3);
image(tmpFig,'AlphaData',alphaChan); axis off
...
% tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\\MonkeyTopDown1Pose_WithLimbCentredAct.jpg');
tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\\MonkeyTopDown1Pose.jpg');
alphaChan = ~all(tmpFig > 250, 3);
image(tmpFig,'AlphaData',alphaChan); axis off
...
% tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\\MonkeyTopDown1Pose_WithHeadCentredAct.jpg');
tmpFig = imread('Results\ForFigures\ProximityPosition\BitsAndPieces\\MonkeyTopDown1Pose.jpg');
alphaChan = ~all(tmpFig > 250, 3);
image(tmpFig,'AlphaData',alphaChan); axis off
...
% % %             sFP.plt.vidFl         = 1;
% % %             sFP.plt.vidFileName   = ['Results\Videos\LimbRight_M' num2str(iM) '.avi'];
% % %             sFP.plt.lmbCol      = 2:14;
...
% % %             NetAnalysis(sFP,w,permute(neurActForPlot{iM},[3 4 1 2 5 6]))
            ...
            sFP.plt.vidFl         = 1;
            sFP.plt.vidFileName   = ['Results\Videos\LimbRight_M' num2str(iM) '_ForwardBack.avi'];
...
% % %             clear v
% % %             sFP.plt.vidFl         = 0;
% % %             sFP.plt.vidFileName   = ['Results\Videos\BodyLeftLimbRight_M' num2str(iM) '.avi'];
% % %             v                     = VideoWriter(sFP.plt.vidFileName);
% % %             v.FrameRate           = sFP.plt.vidFR;
% % %             open(v)
% % %             
% % %             vidFileName2          = ['Results\Videos\BodyStayLimbRight_M' num2str(iM) '.avi'];
% % %             v2                    = VideoWriter(vidFileName2);
% % %             v2.FrameRate          = sFP.plt.vidFR;
% % %             open(v2)
% % %             
% % %             vidFileName3          = ['Results\Videos\BodyLeftLimbStay_M' num2str(iM) '.avi'];
% % %             v3                    = VideoWriter(vidFileName3);
% % %             v3.FrameRate          = sFP.plt.vidFR;
% % %             open(v3)
% % %             
% % %             vidFileName4          = ['Results\Videos\BodyAvLimbRight_M' num2str(iM) '.avi'];
...
%     cFig = figure(f.(cF).f)
%     print(cFig,['Results\ForFigures\ProximityPosition\BitsAndPieces\FromMatlab\' cF ,'-dpfd'])
...
%     saveas(f.(cF).f,['Results\ForFigures\ProximityPosition\BitsAndPieces\FromMatlab\' cF '.svg'] , 'svg')
end
...
% % %     cFig = figure(f.(cF).f)
% % % 
% % %     cName = ['Results\ForFigures\ProximityPosition\BitsAndPieces\FromMatlab\' cF '.pdf'];
% % %     
% % %     switch cF
% % %         case 'HBR'
% % %             export_fig HBR.pdf
...
% % % % % figure,
% % % % % tmpFig = imread('Documentation\Figures\FromOtherPapers\MonkeyForwardOnly.png');
...
% % % % % % tmpFig = imread('Documentation\Figures\FromOtherPapers\BlinkExample_Bufacchi2018.png');
% % % % % % image(tmpFig); axis off
...
% % % % % subplot(10,1,[1:4])
% % % % % tmpFig = imread('Documentation\Figures\FromOtherPapers\MonkeyMoveHand_GrazianoGross1993_2.png');
% % % % % image(tmpFig); axis off
% % % % % title('Top-down sketch of neuron response field around hand')
% % % % % subplot(10,1,6:10)
% % % % % tmpFig = imread('Documentation\Figures\FromOtherPapers\MonkeyMoveHand_GrazianoGross1997.png');
% % % % % image(tmpFig); axis off
