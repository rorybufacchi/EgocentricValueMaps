...
sBdy.clc.actConsequence = [ 0  0  0 ; ... % action 1 stay
    ...
    0  0 -1 ; ... % action 4: hand $left$
    0  0  1 ; ... % action 5: hand $right$
    0  0 -2 ; ... % action 6: hand $left$ FAST
    0  0  2];     % action 7: hand $right$ FAST
...
sBdy.clc.actConsequence = [ 0  0  0 ; ... % action 1 stay
    ...
    0  0 -2 ; ... % action 6: hand $left$ FAST
    0  0  2 ; ... % action 7: hand $right$ FAST
   -1  0  0 ; ... % action 8: body AWAY 
   -2  0  0];     % action 9: body AWAY FAST
...
save('F:\Projects\DPPS\DefenseAgent\Data\The_BEES_plus_AWAYoption_handCanMoveFaster.mat')
...
zPos = sTmp.clc.nearPos(3) + 3; % 7;% POSITION OF SLICE
